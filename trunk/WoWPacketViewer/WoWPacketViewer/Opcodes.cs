namespace WoWPacketViewer
{
    public enum OpCodes
    {
        ...
        CMSG_ALTER_APPEARANCE                           = 0x425,
        SMSG_ENABLE_BARBER_SHOP                         = 0x426,
        SMSG_BARBER_SHOP_RESULT                         = 0x427,
        CMSG_CALENDAR_GET_CALENDAR                      = 0x428,
        CMSG_CALENDAR_GET_EVENT                         = 0x429,
        CMSG_CALENDAR_GUILD_FILTER                      = 0x42A,
        CMSG_CALENDAR_ARENA_TEAM                        = 0x42B,
        CMSG_CALENDAR_ADD_EVENT                         = 0x42C,
        CMSG_CALENDAR_UPDATE_EVENT                      = 0x42D,
        CMSG_CALENDAR_REMOVE_EVENT                      = 0x42E,
        CMSG_CALENDAR_EVENT_INVITE                      = 0x42F,
        CMSG_CALENDAR_EVENT_RSVP                        = 0x430,
        CMSG_CALENDAR_EVENT_REMOVE_INVITE               = 0x431,
        CMSG_CALENDAR_EVENT_STATUS                      = 0x432,
        CMSG_CALENDAR_EVENT_MODERATOR_STATUS            = 0x433,
        SMSG_CALENDAR_SEND_CALENDAR                     = 0x434,
        SMSG_CALENDAR_SEND_EVENT                        = 0x435,
        SMSG_CALENDAR_FILTER_GUILD                      = 0x436,
        SMSG_CALENDAR_ARENA_TEAM                        = 0x437,
        SMSG_CALENDAR_EVENT_ADDED                       = 0x438,
        SMSG_CALENDAR_EVENT_INVITE                      = 0x439,
        SMSG_CALENDAR_EVENT_INVITE_REMOVED              = 0x43A,
        SMSG_CALENDAR_EVENT_STATUS                      = 0x43B,
        SMSG_CALENDAR_COMMAND_RESULT                    = 0x43C,
        SMSG_CALENDAR_RAID_LOCKOUT_ADDED                = 0x43D,
        SMSG_CALENDAR_RAID_LOCKOUT_REMOVED              = 0x43E,
        SMSG_CALENDAR_EVENT_INVITE_ALERT                = 0x43F,
        SMSG_CALENDAR_EVENT_INVITE_REMOVED_ALERT        = 0x440,
        SMSG_CALENDAR_EVENT_INVITE_STATUS_ALERT         = 0x441,
        SMSG_CALENDAR_EVENT_REMOVED_ALERT               = 0x442,
        SMSG_CALENDAR_EVENT_UPDATED_ALERT               = 0x443,
        SMSG_CALENDAR_EVENT_MODERATOR_STATUS_ALERT      = 0x444,
        SMSG_CALENDAR_EVENT_RESERVED_1                  = 0x445,
        SMSG_CALENDAR_EVENT_RESERVED_2                  = 0x446,
        SMSG_CALENDAR_EVENT_RESERVED_3                  = 0x447,
        CMSG_SAVE_DANCE                                 = 0x448,
        SMSG_NOTIFY_DANCE                               = 0x449,
        CMSG_PLAY_DANCE                                 = 0x44A,
        SMSG_PLAY_DANCE                                 = 0x44B,
        CMSG_LOAD_DANCES                                = 0x44C,
        CMSG_STOP_DANCE                                 = 0x44D,
        SMSG_STOP_DANCE                                 = 0x44E,
        CMSG_SYNC_DANCE                                 = 0x44F,
        CMSG_DANCE_QUERY                                = 0x450,
        SMSG_DANCE_QUERY_RESPONSE                       = 0x451,
        SMSG_INVALIDATE_DANCE                           = 0x452,
        CMSG_DELETE_DANCE                               = 0x453,
        SMSG_LEARNED_DANCE_MOVES                        = 0x454,
        CMSG_LEARN_DANCE_MOVE                           = 0x455,
        CMSG_UNLEARN_DANCE_MOVE                         = 0x456,
        CMSG_SET_RUNE_COUNT                             = 0x457,
        CMSG_SET_RUNE_COOLDOWN                          = 0x458,
        MSG_MOVE_SET_PITCH_RATE_CHEAT                   = 0x459,
        MSG_MOVE_SET_PITCH_RATE                         = 0x45A,
        SMSG_FORCE_PITCH_RATE_CHANGE                    = 0x45B,
        CMSG_FORCE_PITCH_RATE_CHANGE_ACK                = 0x45C,
        SMSG_SPLINE_SET_PITCH_RATE                      = 0x45D,
        SMSG_MOVE_ABANDON_TRANSPORT                     = 0x45E,
        MSG_MOVE_ABANDON_TRANSPORT                      = 0x45F,
        CMSG_MOVE_ABANDON_TRANSPORT_ACK                 = 0x460,
        CMSG_UPDATE_MISSILE_TRAJECTORY                  = 0x461,
        SMSG_UPDATE_ACCOUNT_DATA_COMPLETE               = 0x462,
        SMSG_TRIGGER_MOVIE                              = 0x463,
        CMSG_COMPLETE_MOVIE                             = 0x464,
        CMSG_SET_GLYPH_SLOT                             = 0x465,
        CMSG_SET_GLYPH                                  = 0x466,
        SMSG_ACHIEVEMENT_EARNED                         = 0x467,
        SMSG_DYNAMIC_DROP_ROLL_RESULT                   = 0x468,
        SMSG_CRITERIA_UPDATE                            = 0x469,
        CMSG_QUERY_INSPECT_ACHIEVEMENTS                 = 0x46A,
        SMSG_RESPOND_INSPECT_ACHIEVEMENTS               = 0x46B,
        CMSG_DISMISS_CONTROLLED_VEHICLE                 = 0x46C,
        UMSG_UNKNOWN_1133                               = 0x46D,
        SMSG_UNKNOWN_1134                               = 0x46E,    // something todo with quests
        UMSG_UNKNOWN_1135                               = 0x46F,
        SMSG_UNKNOWN_1136                               = 0x470,    // Players in raid combat cannot change raid subgroups
        UMSG_UNKNOWN_1137                               = 0x471,
