namespace WowTools.Core
{
    public enum OpCodes
    {
        ...
        SSMSG_CALENDAR_UPDATE_INVITE_LIST3              = 0x471,
        ...
        SMSG_BATTLEGROUND_INFO_THROTTLED                = 0x4A6, // smsg unk, old SMSG_CLIENTCACHE_VERSION
        ...
        SMSG_ITEM_REFUND_RESULT                         = 0x4B5, // refund something
        CMSG_CORPSE_MAP_POSITION_QUERY                  = 0x4B6, // CMSG, uint32
        CMSG_CORPSE_MAP_POSITION_QUERY_RESPONSE         = 0x4B7, // SMSG, string+float
        ...
        SMSG_ARENA_OPPONENT_UPDATE                      = 0x4C7, // arena pet?
